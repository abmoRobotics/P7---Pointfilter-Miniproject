...
def train(opt):
    ...
    for epoch in range(opt.start_epoch, opt.nepoch):
        network_utils.adjust_learning_rate(optimizer, epoch, opt)
        ...
        for batch_ind, data_tuple in enumerate(train_dataloader):
            ...
            if opt.use_cuda:
                ...
                support_radius = opt.support_multiple * support_radius
                support_radius = support_radius.float()
            ...
            loss = 100 * network_utils.compute_bilateral_loss_with_repulsion(pred_pts, gt_patch, gt_normal,
